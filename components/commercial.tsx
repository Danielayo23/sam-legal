  ...
  return (
    <div className="w-full">
      ...
      {/* <section className="max-w-5xl mx-auto px-6 py-12 text-center"> */}
        ...
        <h1 className="text-3xl  mb-4">Property & Conveyancing Solicitors in Lagos</h1>
        <p className="text-gray-600 leading-relaxed">
          The acquisition of a property is likely to be one of the most important and biggest investments 
          you are likely to make, whether it’s for your business or your home.
        </p><br></br>
        <p className="text-gray-600 leading-relaxed">
