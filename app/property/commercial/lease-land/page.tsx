        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-0.5 lg:px-0.5 py-5 lg:py-5">
          <nav aria-label="Breadcrumb" className="mb-6 text-sm bg-[#8ed1fc] py-3 px-5">
            <ol className="flex items-center gap-2 text-gray-600">
              ...
              <li aria-hidden>››</li>
              <li className="text-gray-900 font-medium">Leasehold Land</li>
            </ol>
          </nav>
          ...
          <div className="grid lg:grid-cols-12 gap-10 items-center">
            <div className="lg:col-span-7">
              <h1 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold tracking-tight text-gray-900">
                Freehold Purchase & Leasehold Extension Solicitors
              </h1>
              <p className="mt-4 text-lg text-gray-700 max-w-2xl">
               Whether you are a commercial property landlord or a tenant, we can help you in all aspects of leasing, 
               licences, property portfolio management, residential and commercial leases.
              </p>
