    ...
    <div className="w-full">
      ...
      {/* <section className="max-w-5xl mx-auto px-6 py-12 text-center"> */}
           <section className="relative overflow-hidden bg-gradient-to-br from-blue-50 to-blue-100 text-center ">
              ...
              <li aria-hidden>››</li>
              <li className="text-gray-900 font-bold">Remortaging</li>
            </ol>
          </nav>
                 </div>
        <h1 className="text-3xl  mb-4">Remortgaging Solicitors</h1>
        <p className="text-gray-600 leading-relaxed">
          Remortgaging your property is the process of moving your mortgage from one lender to another.
        </p><br></br>
        <p className="text-gray-600 leading-relaxed">
            You may be remortgaging to reduce your monthly payments by finding a better deal or you may want
             to release some equity in your property to use for home improvements. Another option may be that 
             you want to reduce the term of your mortgage so that you are mortgage free sooner than originally 
             planned.
        </p><br></br>
        <p className="text-gray-600 leading-relaxed">
            Increasing your borrowing on your current property or changing the terms of your borrowing is a relatively
            straightforward process. Your Lender will provide us with a copy of your mortgage offer and we will  
            report on the terms of the new mortgage offer, whilst also checking the title deeds to your property.   We will then proceed to register the new mortgage at Land Registry.
        </p><br></br>
        {/* <p className="text-gray-600 leading-relaxed">
