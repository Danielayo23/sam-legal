        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-0.5 lg:px-0.5 py-5 lg:py-5">
          <nav aria-label="Breadcrumb" className="mb-6 text-sm bg-[#8ed1fc] py-3 px-5">
            <ol className="flex items-center gap-2 text-gray-600">
              ...
              <li aria-hidden>››</li>
              <li className="text-gray-900 font-bold">Transfer Of Equity</li>
            </ol>
          </nav>
          ...
          <div className="grid lg:grid-cols-12 gap-10 items-center">
            <div className="lg:col-span-7">
              ...
              <p className="mt-4 text-lg text-gray-700 max-w-2xl">
                A Transfer of Equity is the change of legal ownership of a property either by removing a party 
                from the title deeds or by adding a party to the title deeds.
              </p>
